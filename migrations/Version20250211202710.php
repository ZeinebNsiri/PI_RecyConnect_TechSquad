 ...
 */
final class Version20250211202710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_article (id INT AUTO_INCREMENT NOT NULL, nom_categorie VARCHAR(255) NOT NULL, description_categorie VARCHAR(255) NOT NULL, image_categorie VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie_cours (id INT AUTO_INCREMENT NOT NULL, nom_categorie VARCHAR(255) NOT NULL, description_categorie LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, user_com_id INT NOT NULL, post_com_id INT NOT NULL, contenu_com LONGTEXT NOT NULL, date_com DATETIME NOT NULL, INDEX IDX_67F068BC11DE140A (user_com_id), INDEX IDX_67F068BC44AEEB52 (post_com_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `like` (id INT AUTO_INCREMENT NOT NULL, post_like_id INT NOT NULL, ueser_like_id INT NOT NULL, INDEX IDX_AC6340B3B8734D01 (post_like_id), INDEX IDX_AC6340B32F446BE (ueser_like_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, user_p_id INT NOT NULL, contenu LONGTEXT NOT NULL, contenu_multimedia VARCHAR(255) DEFAULT NULL, date_publication DATETIME NOT NULL, nbr_jaime INT NOT NULL, status_post TINYINT(1) NOT NULL, INDEX IDX_5A8A6C8DA9FA2F6B (user_p_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, event_id_id INT NOT NULL, user_id_id INT NOT NULL, nb_places INT NOT NULL, created_at_res DATETIME NOT NULL, updated_at_res DATETIME DEFAULT NULL, INDEX IDX_42C849553E5F2F7B (event_id_id), INDEX IDX_42C849559D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', nom_user VARCHAR(255) NOT NULL, prenom VARCHAR(255) DEFAULT NULL, num_tel VARCHAR(20) NOT NULL, adresse VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, matricule_fiscale VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, photo_profil VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C849553E5F2F7B FOREIGN KEY (event_id_id) REFERENCES evenement (id)');
